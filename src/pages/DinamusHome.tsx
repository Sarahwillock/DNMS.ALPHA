...
const GCS: GC[] = [
  { id: '1', leaders: 'Manoel e Carol', day: 'Quinta', time: '20:00', frequency: 'Quinzenal', whatsapp: '5511991185859' },
  { id: '2', leaders: 'João e Gisely', day: 'Quinta', time: '20:00', frequency: 'Quinzenal', whatsapp: '55119944894120' },
  { id: '3', leaders: 'Beto e Angela', day: 'Quinta', time: '20:00', frequency: 'Quinzenal', whatsapp: '5511988915662' },
  { id: '4', leaders: 'Alan e Cibele', day: 'Quinta', time: '20:00', frequency: 'Quinzenal', whatsapp: '551193242174' },
  { id: '5', leaders: 'Bruno e Diana', day: 'Quinta', time: '20:00', frequency: 'Quinzenal', whatsapp: '5511963970097' }
];
...
export default function DinamusHome() {
  ...
  {GCS.map((gc) => {
    const whatsappLink = `https://wa.me/${gc.whatsapp}?text=${encodeURIComponent(
      `Oi! Quero entrar no GC ${gc.leaders}`
    )}`;
    ...
    return (
      ...
      >
        ...
        <div className="mt-5 space-y-3 text-white/65">
          <div className="flex items-center gap-3">
            <Calendar className="h-5 w-5 text-[#ff987c]/70" />
            <span>{gc.day}</span>
          </div>
          <div className="flex items-center gap-3">
            <CalendarDays className="h-5 w-5 text-[#ff987c]/70" />
            <span>{gc.time}</span>
          </div>
        </div>

        <div className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#AC351B] px-4 py-3 text-sm font-bold text-white">
          Entrar no GC <ArrowRight className="h-4 w-4" />
        </div>
      </motion.a>
    );
  })}
