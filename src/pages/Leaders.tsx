    ...
    <div className="relative min-h-screen overflow-hidden bg-neutral-950 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl p-4 sm:p-6 md:p-10 lg:p-16">
        <header className="mb-10 sm:mb-16">
          ...
          >
            <h1 className="font-bauhaus text-4xl uppercase leading-none sm:text-6xl md:text-7xl lg:text-8xl">
              LÍDERES <br />
            ...
            <p className="max-w-2xl text-sm font-bold uppercase tracking-[0.2em] text-gray-400 sm:text-base md:text-xl">
